...
export default function Hero() {
  ...
  // Memoize typewriter effect to prevent unnecessary re-renders
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center py-1 lg:py-1">
        ...
        >
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-tight">
              Hello, I&rsquo;m <span className="text-[#F2B47E] relative inline-block">
                Sanusi MB
            ...
            <p className="text-gray-300 text-base md:text-lg lg:text-xl leading-relaxed max-w-2xl">
               I am a Software Engineer and MSc candidate in Computer Science specializing in AI systems and intelligent applications. With expertise in Python, TypeScript, React, and Next.js, I build and deploy AI-integrated systems including LLM applications, AI agents, and reinforcement learning prototypes. I focus on practical deployment of intelligent systems, from web and mobile applications to edge and embedded environments, with experience in backend services, real-time interfaces, and DevOps for AI.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pt-4">
              ...
              <Link 
                href="/SB Mustapha CV.pdf" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="w-full sm:w-auto px-6 lg:px-8 py-3 lg:py-3.5 bg-black/30 backdrop-blur-sm border border-[#F2B47E] text-[#F2B47E] font-bold rounded-lg hover:bg-[#F2B47E]/10 transition-all duration-300 group flex items-center justify-center gap-2"
          ...
          >
            <div className="relative">
              {/* Reduced blur and opacity for better performance */}
              <div className="absolute -inset-1 bg-gradient-to-r from-[#F2B47E]/15 to-[#F2B47E]/25 rounded-full blur-lg opacity-50 animate-pulse"></div>
              <div className="relative rounded-full overflow-hidden border-4 border-[#F2B47E]/80 shadow-2xl shadow-black/50 h-64 w-64 sm:h-72 sm:w-72 lg:h-80 lg:w-80 xl:h-96 xl:w-96">
                <Image
                  ...
                  priority
                  quality={85} // Reduced from default 75 to 85 for better balance
                />
              </div>
